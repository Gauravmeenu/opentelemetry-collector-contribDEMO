...
type esClientCurrent = opensearch.Client
type esConfigCurrent = opensearch.Config
type esBulkIndexerCurrent = opensearchesutil.BulkIndexer
type esBulkIndexerItem = opensearchesutil.BulkIndexerItem
type esBulkIndexerResponseItem = opensearchesutil.BulkIndexerResponseItem
...
func newElasticsearchClient(logger *zap.Logger, config *Config) (*esClientCurrent, error) {
	...
	return opensearch.NewClient(esConfigCurrent{
		Transport: transport,
...
func newBulkIndexer(logger *zap.Logger, client *opensearch.Client, config *Config) (esBulkIndexerCurrent, error) {
	// TODO: add debug logger
	return opensearchesutil.NewBulkIndexer(opensearchesutil.BulkIndexerConfig{
